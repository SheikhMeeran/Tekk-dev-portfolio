...
import { Box, Grid, Typography, Container, useMediaQuery, Button } from "@mui/material";
import { useTheme } from "@mui/material/styles";
import { motion, useInView } from "framer-motion";
import Lottie from "lottie-react";
...
const scaleAnimationJSX = <Lottie animationData={scaleAnimation} style={{ width: 400, height: 200 }} />;
const automationAnimationJSX = <Lottie animationData={automationAnimation} style={{ width: 400, height: 200 }} />;
const uxAnimationJSX = <Lottie animationData={uxAnimation} style={{ width: 400, height: 200 }} />;
const documentsAnimationJSX = <Lottie animationData={documentsAnimation} style={{ width: 400, height: 200 }} />;
          ...
          {[
            ...
            return (
              <Grid
                ...
                direction={medium ? "column" : "row"}
                sx={sectionStyle}
                ref={section.title === "Application development" ? targetRef : null}
