...
// // Responsive Lottie wrappers
// const scaleAnimationJSX = (
//   <Box sx={{ width: { xs: "100%", sm: 300, md: 400 }, height: "auto" }}>
//     <Lottie animationData={scaleAnimation} />
//   </Box>
// );
// const automationAnimationJSX = (
//   <Box sx={{ width: { xs: "100%", sm: 300, md: 400 }, height: "auto" }}>
//     <Lottie animationData={automationAnimation} />
//   </Box>
// );
// const uxAnimationJSX = (
//   <Box sx={{ width: { xs: "100%", sm: 300, md: 400 }, height: "auto" }}>
...
// const documentsAnimationJSX = (
//   <Box sx={{ width: { xs: "100%", sm: 300, md: 400 }, height: "auto" }}>
//     <Lottie animationData={documentsAnimation} />
//   </Box>
// );
