...
const Software = (props) => {
  ...
  <Grid item xs={12} md={6} container direction="column" spacing={2}>
    ...
    <Grid item>
      <Typography variant="body1" paragraph>
        Governance, Risk and Compliance (GRC) is the strategic and secure
        approach to manage the security risks, to help strategize and enable
        their business objectives to be compliant with regulatory requirements.
        The key components of GRC are:
      </Typography>
      <Typography variant="body1" paragraph>
        ❖ Governance: Includes establishing a framework for organization
        technology infrastructure, covering policies, procedures, roles and
        responsibilities
      </Typography>
      <Typography variant="body1" paragraph>
        ❖ Risk Management: Identify assess, manage vulnerabilities and threats
        that can compromise
      </Typography>
      <Typography variant="body1" paragraph>
        ❖ Compliance: Adhere to industry identified mandatory regulations,
    ...
    <Grid item>
      <Typography variant="body1" paragraph>• Reduced Risk</Typography>
      <Typography variant="body1" paragraph>• Improved Compliance</Typography>
      <Typography variant="body1" paragraph>• Security Robustness</Typography>
      <Typography variant="body1" paragraph>
  ...
  <Grid item xs={12} md={6} container direction="column" spacing={2}>
    ...
    <Grid item>
      <Typography variant="body1" paragraph>
        Vulnerability assessment is not just identifying weaknesses within the
        system but for us to lay down the understanding on the way to strengthen
        the entire business ecosystem. Penetration Testing, a critical part of
        cybersecurity, commonly referred as “Pen Test”, is the simulated
        authorized challenge performed on a computer system to evaluate the
        security of the system and is a separate activity. Our experienced
        ‘PenTest’ engineers are skilled to perform:
      </Typography>
      <Typography variant="body1" paragraph>❖ “Blackbox Pen Test”</Typography>
      <Typography variant="body1" paragraph>❖ “GreyBox Pen Test”</Typography>
      <Typography variant="body1" paragraph>❖ “WhiteBox Pen Test”</Typography>
    </Grid>
  </Grid>
</Grid>
...
<Grid container spacing={4} alignItems="center">
  ...
  <Grid item xs={12} md={6} container direction="column" spacing={2} className={classes.heading}>
    ...
    <Grid item>
      <Typography variant="body1" paragraph>
        Unfortunately, incidents do occur. When the incident occurs, our
        preferred way to handle it is in such a way that minimal interruptions
        to work occur and recovery times are negligible. Our Incident Response
        team:
      </Typography>
      <Typography variant="body1" paragraph>
        ❖ Works closely with C-suite, Security, Technology and Legal and as
        needed HR teams.
      </Typography>
      <Typography variant="body1" paragraph>
        ❖ Provides simplified written instructions, guidelines, and maintains
        checklists to help build proactiveness to respond to a repeat incident.
      </Typography>
    </Grid>
  </Grid>
...
<Grid container spacing={4} alignItems="center">
  ...
  <Grid item xs={12} md={6} container direction="column" spacing={2} className={classes.heading}>
    ...
    <Grid item>
      ...
      <Typography variant="body1" paragraph>
        ❖ Promptly responding with necessary action policies.
      </Typography>
      <Typography variant="body1" paragraph>
